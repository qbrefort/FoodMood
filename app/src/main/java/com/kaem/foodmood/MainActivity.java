...
public class MainActivity extends AppCompatActivity implements MoodFragment.OnSendMoodStatusListener, WelcomeFragment.OnSendFeelStatusListener {
    ...
    private FragmentTransaction mFT =getFragmentManager().beginTransaction();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.kaem.foodmood/http/host/path")
        );
